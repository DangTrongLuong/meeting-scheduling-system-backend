...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, UUID> {
    ...
    // Lấy danh sách người dùng đã chat (distinct)
    @Query("SELECT DISTINCT CASE " +
            ...
            "ORDER BY cm.sentAt DESC")
    List<com.meeting.schedule_a_meeting.entities.Users> findChatPartners(@Param("userId") UUID userId);
    ...
    ChatMessage findFirstByOrderBySentAtDesc();
